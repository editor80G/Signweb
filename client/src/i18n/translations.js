...
export const translations = {
    ru: {
        ...
        ACCOUNT_REGISTER_TITLE: 'Зарегистрируйтесь для просмотра наших изданий',
        ...
        ACCOUNT_LOGIN: 'Войти',
        ACCOUNT_ALREADY_HAVE_ACCOUNT: 'Уже есть аккаунт?',
        ACCOUNT_DO_NOT_HAVE_AN_ACCOUNT: 'Еще нет аккаунта?',
        ACCOUNT_GO_TO_LOGIN: 'Перейти к входу',
        ACCOUNT_LOGIN_TITLE: 'Войдите для просмотра наших изданий',
    ...
    en: {
        ...
        ACCOUNT_REGISTER_TITLE: 'Register to View Our Publications',
        ACCOUNT_EMAIL: 'Email',
        ...
        ACCOUNT_LOGIN: 'Login',
        ACCOUNT_ALREADY_HAVE_ACCOUNT: 'Already have an account?',
        ACCOUNT_DO_NOT_HAVE_AN_ACCOUNT: 'Don\'t have an account yet?',
        ACCOUNT_GO_TO_LOGIN: 'Go to login',
        ACCOUNT_LOGIN_TITLE: 'Login to View Our Publications',
